...
This governance policy sets forth the proposal process for projects to be accepted into the Cloud Native Computing Foundation (“OpenSSF”). The process is the same for both existing projects which seek to move into the OpenSSF, and new projects to be formed within the OpenSSF.
...
. *Project Proposal*
   ...
   * The TOC may agree that the project does not (yet) meet the https://github.com/ossf/tac/blob/main/process/graduation_criteria.adoc#incubation-stage[Incubation requirements] and give feedback on why this is the case. If the project is not already in the OpenSSF, the TOC may suggest that project apply for Sandbox instead.
...
. *Due Diligence* _2-3 months_
   * TOC Incubation Sponsor drives due diligence (see the https://github.com/ossf/tac/blob/main/process/dd-review-template.md[template] and https://github.com/ossf/tac/blob/main/process/due-diligence-guidelines.md[guidelines]).
   * TOC Incubation Sponsor can delegate DD work to OpenSSF TAGs and/or other TOC members.
   * Typically DD includes a presentation to a OpenSSF TAG, as identified by the TOC Sponsor. This step may be omitted if the TOC Sponsor feels there are readily-available and suitable presentations on video - for example, because the TAG has already recently held a presentation. (We do not want unnecessary levels of process or bureaucracy to delay a widely-known and adopted project from joining the OpenSSF). TOC Sponsor has discretion to arrange alternatives (for example, arranging a Q&A session at a TOC meeting) to ensure there is ample opportunity to ask questions.
   ...
   * TOC Incubation Sponsor confirms that project meets the https://github.com/ossf/tac/blob/main/process/graduation_criteria.adoc#incubation-stage[Incubation requirements].
...
. *TOC vote* _up to 6 weeks_
   * TOC members assess whether project meets the https://github.com/ossf/tac/blob/main/process/graduation_criteria.adoc#incubating-stage[Incubation criteria]
...
. *TOC vote*
   * TOC members assess whether project meets the https://github.com/ossf/tac/blob/main/process/graduation_criteria.adoc#graduation-stage[Graduation criteria]
