== OpenSSF Graduation Criteria v1.3
...
The criteria for each stage of maturity are described below, and there is a separate link:project_proposals.adoc[Project Proposal process].
...
See the link:sandbox.md[OpenSSF Sandbox Guidelines] for the detailed process.

=== Incubating Stage

*Note: The incubation level is the point at which we expect to perform full linklink:ue-diligence-guidelines.md[due diligence] on projects.*
