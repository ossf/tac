...
**Current Status:**
  ...
  - **The TAC reviewed the associated [funding request](https://github.com/ossf/tac/issues/530) and declined it, noting the existence of the CycloneDX VDR format.** The TAC recommended engaging with the CycloneDX community rather than creating a competing format.

**Up Next (Next 4–8 Weeks):**

1.  ~TAC vote for this initiative is open: https://github.com/ossf/tac/issues/530~ TAC vote has not passed.
