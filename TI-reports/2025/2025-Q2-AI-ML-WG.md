...
The members working on this have scheduled a due date in Q2.

### Up Next

The main item of discussion in the past few meetings has been
[the AI economics SIG](https://github.com/ossf/ai-ml-security/issues/27). We are
investigating if the group is the best fit for the SIG and planning some clearly
...
Launch of v1.0 scheduled for March 31st. This will have a stable API, clear
